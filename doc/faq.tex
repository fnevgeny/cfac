...
described later \cite{gu:2008a}, which can be used as the reference. A more
detailed description of the code can be found in the draft papers which are
included in the \cFAC distribution.}

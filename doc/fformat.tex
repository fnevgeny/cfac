...
In order to use it, (i) call \key{StoreInit}, (ii) call \key{StoreTable} every
time when \key{PrintTable} would have been used for the ASCII output, and
finally, (iii) call \key{StoreClose}. Please note that if desired, ASCII and
SQLite data can be output simultaneously.

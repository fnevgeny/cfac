...
For each level in the group list \var{g0}, eliminate all mixing components
that are either not in the group list \var{g1} or their mixing coefficients
are lesser (by the absolute value) than \var{c}. In the latter case, the group
list \var{g1} may be empty.
\end{fundesc}
